            ...
            <div className="order-2 lg:order-1 animate-fade-in">
              ...
              <div className="flex gap-4 justify-center mt-6">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/10  transition-all"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center p-2 justify-center w-10 h-10 rounded-full bg-white/10  transition-all"
